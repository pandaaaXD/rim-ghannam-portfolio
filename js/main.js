...
(function () {
  ...
  const I18N = {
    fr: {
      ...
      "glpi.desc": "Déploiement d'une plateforme GLPI redondée pour le ticketing et la CMDB de l'entreprise : réplication des fichiers avec GlusterFS, base MariaDB répliquée, répartition de charge HAProxy et bascule automatique d'IP virtuelle avec Keepalived.",
      ...
      "mon.title": "Stack de monitoring Grafana / Loki / PRTG",
      "mon.role": "Déploiement supervision &amp; centralisation des logs",
      "mon.desc": "Mise en place d'une stack de supervision : centralisation des logs avec Loki et Promtail, tableaux de bord Grafana pour la visualisation, et PRTG pour la supervision réseau et les alertes sur les équipements.",
      "mon.i1": "<strong>Logs centralisés</strong> : fini le SSH serveur par serveur pour retrouver une erreur",
      "mon.i2": "<strong>Détection proactive</strong> : alertes PRTG sur les équipements réseau avant que les utilisateurs n'appellent",
      "mon.i3": "<strong>Diagnostic accéléré</strong> : dashboards Grafana croisant métriques et logs au même endroit",
      ...
      "exp.i3": "Déploiement d'une stack de <strong>monitoring Grafana / Loki / PRTG</strong>",
    ...
    en: {
      ...
      "glpi.desc": "Deployed a redundant GLPI platform for the company's ticketing and CMDB: file replication with GlusterFS, replicated MariaDB database, HAProxy load balancing and automatic virtual-IP failover with Keepalived.",
      ...
      "mon.title": "Grafana / Loki / PRTG monitoring stack",
      "mon.role": "Monitoring rollout &amp; log centralisation",
      "mon.desc": "Built a monitoring stack: log centralisation with Loki and Promtail, Grafana dashboards for visualisation, and PRTG for network monitoring and equipment alerts.",
      "mon.i1": "<strong>Centralised logs</strong>: no more SSH-ing server by server to hunt down an error",
      "mon.i2": "<strong>Proactive detection</strong>: PRTG alerts on network equipment before users even call",
      "mon.i3": "<strong>Faster diagnosis</strong>: Grafana dashboards cross-referencing metrics and logs in one place",
      ...
      "exp.i3": "Rolled out a <strong>Grafana / Loki / PRTG monitoring stack</strong>",
