...
(function () {
  ...
  const I18N = {
    fr: {
      ...
      "mon.title": "NOC — supervision centralisée Grafana (ELK · Loki · PRTG)",
      "mon.role": "Conception d'un centre de supervision (NOC) multi-sources",
      "mon.desc": "Mise en place d'un NOC : un point d'observation unique dans Grafana qui fédère plusieurs sources — les logs indexés dans ELK (Elasticsearch), les logs applicatifs collectés par Loki/Promtail et la supervision réseau PRTG — pour surveiller toute l'infrastructure depuis un seul écran.",
      "mon.i1": "<strong>Un seul écran</strong> : métriques, logs et état du réseau réunis dans des dashboards Grafana communs",
      "mon.i2": "<strong>Trois sources fédérées</strong> : Elasticsearch (ELK), Loki et PRTG interrogés depuis le même outil",
      "mon.i3": "<strong>Diagnostic accéléré</strong> : une alerte réseau PRTG se corrèle aux logs ELK/Loki au même endroit",
    ...
    en: {
      ...
      "mon.title": "NOC — centralised monitoring with Grafana (ELK · Loki · PRTG)",
      "mon.role": "Designed a multi-source network operations center (NOC)",
      "mon.desc": "Built a NOC: a single pane of glass in Grafana federating several sources — logs indexed in ELK (Elasticsearch), application logs collected by Loki/Promtail and PRTG network monitoring — to watch the whole infrastructure from one screen.",
      "mon.i1": "<strong>One screen</strong>: metrics, logs and network health brought together in shared Grafana dashboards",
      "mon.i2": "<strong>Three federated sources</strong>: Elasticsearch (ELK), Loki and PRTG queried from the same tool",
      "mon.i3": "<strong>Faster diagnosis</strong>: a PRTG network alert correlates with ELK/Loki logs in the same place",
