...
(function () {
  ...
  const I18N = {
    fr: {
      ...
      "mon.i2": "<strong>Le dashboard client = investigation</strong> : template PRTG multi-clients — CPU / RAM / disque par rôle serveur, rechargé sur le parc d'un client via une variable auto-remplie",
    ...
    en: {
      ...
      "mon.i2": "<strong>The client dashboard = investigation</strong>: multi-tenant PRTG template — CPU / RAM / disk per server role, reloaded onto a client's fleet via an auto-filled variable",
